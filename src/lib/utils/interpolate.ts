...
function createMixers<T>(output: T[], ease?: EasingFunction | EasingFunction[], customMixer?: MixerFactory<T>) {
...
export function interpolate<T>(
	...
	return isClamp ? (v: number) => interpolator(clamp(input[0], input[inputLength - 1], v)) : interpolator;
}